...
**Важно:** Пароль показывается **только один раз** в консоли при первом запуске. Он **не** сохраняется в лог-файлах. Если вы закрыли консоль и не сохранили пароль — см. ниже.
