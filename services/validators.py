...
def validate_name(name: Any, min_length: int = 2, max_length: int = 64) -> Tuple[bool, Optional[str]]:
    """
...
def validate_positive_int(value: Any, field_name: str = "Значение") -> Tuple[int, Optional[str]]:
    """
...
def validate_float_range(
    ...
    try:
        ...
        if float_value < min_val or float_value > max_val:
            return min_val, f"{field_name} должно быть в диапазоне [{min_val}, {max_val}]"
